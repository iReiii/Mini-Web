...
<body class="bg-gray-50 flex min-h-screen">
    ...
    <div class="flex-1 p-8 flex justify-center items-center min-h-screen">
        <div class="w-full max-w-lg bg-white p-8 rounded-lg shadow-lg mt-10"> 
            ...
            <form action="tambah_pasien.php" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="flex justify-center mt-6">
                    <button type="submit" name="submit" class="w-full bg-green-500 hover:bg-green-600 transition text-white px-4 py-2 rounded-md font-semibold">Tambah</button>                </div>
                </div>
            </form>
        </div>
    </div>
