...
$pasien = data_pasien(); // Mengambil semua data pasien dari database

if (!$pasien) {
    die("Tidak ada data pasien yang ditemukan.");
}

$pdf = new FPDF();
$pdf->SetTitle('Data Pasien Rumah Sakit');
